...
export const userAPI = {
  ...
  progress: {
    get: () => api.get('/user/progress'),
        ...
        getLanguageProgress: (languageId) => api.get(`/progress/language/${languageId}`), // ✅ BARU!
  ...
  exercises: {
    ...
    getLanguageBadges: (languageId) => api.get(`/languages/${languageId}/badges`), // ✅ BARU!
  },
    profile: {
...
export const adminAPI = {
  ...
  languages: {
    ...
    update: (id, data) => api.post(`/admin/languages/${id}`, data),
  ...
  sections: {
    ...
    update: (id, data) => api.post(`/admin/sections/${id}`, data),
